...
- Added a draft integration with `flexstanr`, allowing
  [`fit()`](https://accidda.github.io/SeverityEstimate/reference/fit.md)
  to accept backend-portable `stan_options()` and routing fitting and
  posterior extraction through the selected Stan backend.
  [\#147](https://github.com/ACCIDDA/SeverityEstimate/issues/147).
